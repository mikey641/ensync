...
Conversation prose renders validated HTTPS Markdown links, angle links, and bare URLs as keyboard-focusable external anchors. Fenced code, inline code, images, local paths, and unsupported or unsafe schemes remain inert text; the native shell continues to open only HTTPS destinations in the system browser.
