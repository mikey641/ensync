# Ensync Microsoft Store listing — English (United States)
...
© 2026 Michael Hasson. All rights reserved.
...
1. `01-conversation-workspace.png` — Conversation-first workspace with verified project context and Auto Context.
2. `02-settings-and-live-sync.png` — Live server-account sign-in and conversation layout preferences.

Both images are true PNG files at 1366 × 768. Leave optional Xbox, trailer, poster-art, box-art, and promotional-image fields blank for this Windows desktop beta.
